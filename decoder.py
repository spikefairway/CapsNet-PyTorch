...
class Decoder(nn.Module):
    def __init__(self, num_in_capsules=10, in_capsule_size=16,
                 out_image_channels=1, out_image_width=28, out_image_height=28):
        super(Decoder, self).__init__()

        self.in_vector_size = num_in_capsules * in_capsule_size # digit_capsules x digit_capsule_size = 10 x 16

        self.out_image_channels = out_image_channels
        self.out_image_width = out_image_width
        self.out_image_height = out_image_height
